...
CREATE TABLE `articolo` (
  ...
  KEY `fk_articolo_categoria1_idx` (`categoria_idcategoria`),
  CONSTRAINT `fk_articolo_categoria1` FOREIGN KEY (`categoria_idcategoria`) REFERENCES `categoria` (`idcategoria`)
