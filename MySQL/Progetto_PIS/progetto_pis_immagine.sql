...
CREATE TABLE `immagine` (
  ...
  KEY `fk_immagini_prodotto1_idx` (`prodotto_articolo_idarticolo`),
  CONSTRAINT `fk_immagini_prodotto1` FOREIGN KEY (`prodotto_articolo_idarticolo`) REFERENCES `prodotto` (`articolo_idarticolo`)
