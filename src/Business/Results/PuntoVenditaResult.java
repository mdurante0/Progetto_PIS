...
public class PuntoVenditaResult {
    ...
    public enum Result { ADD_OK, SALEPOINT_ALREADY_EXISTS, DEPOSIT_ERROR, SALEPOINT_ERROR, SALEPOINT_DOESNT_EXIST, DELETE_OK, UPDATE_SALEPOINT_OK, DEPOSIT_DOESNT_EXIST, SALEPOINT_CARICATI, UPDATE_DEPOSIT_OK }
