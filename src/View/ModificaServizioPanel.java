...
public class ModificaServizioPanel extends JPanel {
    ...
    public ModificaServizioPanel(MainFrame frame, Servizio servizio) {
        this.frame = frame;

        this.setLayout(new BorderLayout());
        JLabel titleLabel = new JLabel("Modifica servizio");
        ...
        nomeServizioField = new JTextField(servizio.getName(),20);
        descrizioneField = new JTextField(servizio.getDescrizione(),20);
        prezzoField = new JTextField(String.valueOf(servizio.getPrezzo()),20);
