...
import Model.Utente;
import View.Listener.AbilitazioneClienteListener;
import View.Listener.GoToMenuListener;
import View.Listener.JTableButtonMouseListener;
import View.Listener.RemoveClienteListener;
...
public class MostraClientiPanel extends JPanel {
    ...
    public MostraClientiPanel(MainFrame frame) {
        ...
        if (u instanceof Manager m) {
            ...
            ClienteResult clienteResult = ClienteBusiness.getInstance().caricaClienteByPuntoVendita(puntoVenditaResult.getPuntiVendita().get(0));
            ArrayList<Cliente> clienti = clienteResult.getClienti();
